...
public class Aldea {
    ...
    public void cargarFichero() {
        try {
            ...
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream("repuestos.dat"));
            setMapaAladeanos((Map<String, Aldeano>) ois.readObject());
            ois.close();

        } catch (FileNotFoundException e) {
            System.out.println("El fichero repuestos.dat no existe");
    ...
    public void escribirDatosFichero() {
        ...
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("repuestos.dat"));
